...
public final class ServiceNameGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<FileSendRequest,
      FileSendResponse> getFileSendProcedureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "fileSendProcedure",
      requestType = FileSendRequest.class,
      responseType = FileSendResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<FileSendRequest,
      FileSendResponse> getFileSendProcedureMethod() {
    io.grpc.MethodDescriptor<FileSendRequest, FileSendResponse> getFileSendProcedureMethod;
    if ((getFileSendProcedureMethod = ServiceNameGrpc.getFileSendProcedureMethod) == null) {
      synchronized (ServiceNameGrpc.class) {
        if ((getFileSendProcedureMethod = ServiceNameGrpc.getFileSendProcedureMethod) == null) {
          ServiceNameGrpc.getFileSendProcedureMethod = getFileSendProcedureMethod =
              io.grpc.MethodDescriptor.<FileSendRequest, FileSendResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "fileSendProcedure"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  FileSendRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  FileSendResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ServiceNameMethodDescriptorSupplier("fileSendProcedure"))
              .build();
        }
      }
    }
    return getFileSendProcedureMethod;
  }
  ...
  public static abstract class ServiceNameImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void fileSendProcedure(FileSendRequest request,
        io.grpc.stub.StreamObserver<FileSendResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFileSendProcedureMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getFileSendProcedureMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                FileSendRequest,
                FileSendResponse>(
                  this, METHODID_FILE_SEND_PROCEDURE)))
          .build();
    }
  }
  ...
  public static final class ServiceNameStub extends io.grpc.stub.AbstractAsyncStub<ServiceNameStub> {
    ...
    public void fileSendProcedure(FileSendRequest request,
        io.grpc.stub.StreamObserver<FileSendResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
          getChannel().newCall(getFileSendProcedureMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ServiceNameBlockingStub extends io.grpc.stub.AbstractBlockingStub<ServiceNameBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<FileSendResponse> fileSendProcedure(
        FileSendRequest request) {
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
          getChannel(), getFileSendProcedureMethod(), getCallOptions(), request);
    }
  }
  ...
  private static final int METHODID_FILE_SEND_PROCEDURE = 3;
      ...
      switch (methodId) {
        ...
        case METHODID_FIB_PROCEDURE:
          serviceImpl.fibProcedure((FibRequest) request,
              (io.grpc.stub.StreamObserver<FibResponse>) responseObserver);
          break;
        case METHODID_FILE_SEND_PROCEDURE:
          serviceImpl.fileSendProcedure((FileSendRequest) request,
              (io.grpc.stub.StreamObserver<FileSendResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (ServiceNameGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getFileSendProcedureMethod())
              .build();
        }
      }
    }
