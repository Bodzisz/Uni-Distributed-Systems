 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://service.bodzisz.github.io/", wsdlLocation = "file:/Users/kacperwojcicki/University/RSI/Lab5/Client/src/main/resources/personservice.wsdl")
    ...
    extends Service
{
    ...
    private static final QName PERSONSERVICE_QNAME = new QName("http://service.bodzisz.github.io/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/kacperwojcicki/University/RSI/Lab5/Client/src/main/resources/personservice.wsdl");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://service.bodzisz.github.io/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.bodzisz.github.io/", "PersonServiceImplPort"), PersonService.class, features);
    }
